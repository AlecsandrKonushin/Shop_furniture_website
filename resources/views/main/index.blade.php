    ...
    <div class="container-xl">
        ...
        <div class="row g-4 mb-4">
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-60">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1">Товаров</h4>
            ...
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-60">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1">Категорий</h4>
                        <div class="stats-figure">{{ $categoriesCount }}</div>
                    </div>
                    <a class="app-card-link-mask" href="#"></a>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="app-card app-card-stat shadow-sm h-60">
                    <div class="app-card-body p-3 p-lg-4">
                        <h4 class="stats-type mb-1">Цветов</h4>
                        <div class="stats-figure">{{ $colorsCount }}</div>
                    </div>
                    <a class="app-card-link-mask" href="#"></a>
                </div>
            </div>
...
{{--                                    <a href="{{ asset('charts.html') }}">More charts</a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
